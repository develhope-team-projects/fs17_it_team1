...
export function NormalButton(props: ButtonElements) {
    ...
    return (
        <div className="flex no-wrap items-center">
            <Button onClick={props.function} theme={customTheme} color="primary" className=' hover:text-oro-chiaro focus:ring-oro-chiaro focus:bg-our-black focus:text-oro-chiaro'>
                <p>{props.content}</p>
                {props.svg && props.svg}
            </Button>
        </div>
